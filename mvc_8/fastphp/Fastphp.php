...
class Fastphp
{
    ...
    {
    	//判断是调试阶段还是上线阶段  true  false
        if (APP_DEBUG === true) {
            error_reporting(E_ALL);  // 报告所有错误
            ini_set('display_errors','On');  // 开启错误回显，若出现错误，则报错，出现错误提示
        } else {
            error_reporting(E_ALL);
            ini_set('display_errors','Off'); //  关闭错误回显，若出现错误，则提示：服务器错误。但是不会出现错误提示
            ini_set('log_errors', 'On'); //  开启日志
        }
    }
